        ...
        <div id="main">            
            ...
            <form action="addCost.do" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="costType" id="1" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" checked="checked" id="2" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="costType" id="3" onclick="feeTypeChange(3);" />

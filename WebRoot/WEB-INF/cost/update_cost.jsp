        ...
        <div id="main">            
            ...
            <form action="updateCost.do" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="cost_type" value="1" id="1" <c:if test="${cost.cost_type == 1}">checked</c:if> onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="cost_type" value="2" id="2" <c:if test="${cost.cost_type == 2}">checked</c:if> onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="cost_type" value="3"  id="3" <c:if test="${cost.cost_type == 3}">checked</c:if> onclick="feeTypeChange(3);" />
                ...
                <div class="button_info clearfix">
                    ...
                    <input type="reset" value="取消" class="btn_save"  onclick="history.back();" />
                </div>
            </form>
        </div>
        <!--主要区域结束-->
